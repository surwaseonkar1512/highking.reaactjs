...
import Ad from "../assets/advanture.png";
...
const Header = () => {
  ...
  return (
    <section className=" bg-Hero bg-cover bg-fixed py-4 md:px-24 px-4">
      <Nav />
      <div className="flex md:flex-row flex-col gap-5 pt-20">
        <div className="flex-1">
        <div className="flex-1    flex justify-center  ">
        <img src={Ad} alt="hero" className="h-3/4" />
        </div>
          <h1
            className="md:text-2xl text-2xl font-semibold tracking-wide md:leading-tight
          leading-snug"
          >
        ...
        <div className="flex-1    flex justify-center  ">
        <img src={HeroImg} alt="hero" className="h-3/4" />
        </div>
      </div>
